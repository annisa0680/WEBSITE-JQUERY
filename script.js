...
$(document).ready(function() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        const filesMenu = document.querySelector(".nav-list li:nth-child(5)"); // Pilih item "Files"
        const dropdownContent = filesMenu.querySelector(".dropdown-content");
      
        filesMenu.addEventListener("click", function(event) {
          event.stopPropagation(); // Mencegah event click menyebar ke elemen lain
          dropdownContent.style.display = dropdownContent.style.display === "block" ? "none" : "block";
        });
      
        document.addEventListener("click", function() {
          dropdownContent.style.display = "none"; // Tutup dropdown jika klik di luar
        });
      });
